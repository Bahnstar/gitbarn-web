              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          className="w-full rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-xs focus:border-green-500 focus:outline-hidden focus:ring-1 focus:ring-green-500"
                          required
                        />
                      </div>
                      {isSupportOrAdmin() && (
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    ...
                    className="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:ml-3 sm:mt-0 sm:w-auto sm:text-sm"
                  >
                    Cancel
                  </button>
                </div>
