      ...
      <div className="mt-10 px-2 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div className="rounded-lg bg-white px-6 py-12 shadow sm:px-12">
          <Form className="md:col-span-2" action={signup} showSubmitButton={false}>
            <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:max-w-xl sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <input
                  ...
                  minLength={6}
                  required
                  className="mt-2 block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-500 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 sm:text-sm sm:leading-6"
                />
              </div>
            ...
            <button
              type="submit"
              className="mt-8 w-full rounded-md bg-green-600 px-3 py-4 text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
            >
              Sign Up
            </button>
          </Form>
